...
from hloc import match_features2, match_features
...
class FeatureMatching1:
    ...
    def __init__(self, outputs, capture, query_id, ref_id, config,
                 ...
                 extraction: FeatureExtraction1,
                 extraction_ref: Optional[FeatureExtraction1] = None,
        ...
        # overwrite = False
        return # test 22-6
        if is_query_map and 'dkm' in config['hloc']['model']['name']:
            print(f'start query-map dkm matching...')
            match_features2.main(
                config['hloc'],
        ...
        elif 'dkm' in config['hloc']['model']['name']:
            print(f'start map-map dkm matching...')
            match_features2.main(
                config['hloc'],
                pair_selection.paths.pairs_hloc,
                extraction.paths.features,
