...
BENCHMARKING_DIR="benchmarking_salad" # use benchmarking_salad for benchmarking
...
# SCENES=("hydro" "succu")
SCENES=("hydro") # submit only hydro
GLOBAL_FEATURE_METHOD="megaloc" # use megaloc for submission
